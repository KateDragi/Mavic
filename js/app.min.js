...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://rock/./node_modules/swiper/shared/classes-to-selector.mjs?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _libs_dynamic_adapt_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/dynamic_adapt.js */ \"./src/js/libs/dynamic_adapt.js\");\n/* harmony import */ var _modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders.js */ \"./src/js/modules/sliders.js\");\n/* harmony import */ var _libs_functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./libs/functions.js */ \"./src/js/libs/functions.js\");\n\n\n\n\n\n\ndocument.addEventListener(\"click\", clickOperator);\n\n\nlet placeSlider = document.querySelector(\".benefits-page__items\");\nlet placeWrapper = document.querySelector(\".benefits-page__first-line\");\nlet slides = document.querySelectorAll(\".benefits-block\");\n\nlet contentBlock = document.querySelector(\".character-page__content\");\nlet connectionFirst = document.querySelector(\".character-page__connection_first\");\nlet connectionSecond = document.querySelector(\".character-page__connection_second\");\nlet connectionThird = document.querySelector(\".character-page__connection_third\");\nlet connectionFourth = document.querySelector(\".character-page__connection_fourth\");\n\nlet headerLinks = document.querySelectorAll(\".header__link\");\n\n\nlet contentWidth = 1240;\n\nfunction clickOperator(event) {\n    let targetClick = event.target;\n    if (targetClick.closest(\".icon-menu\")) {\n        burgerToggle();\n    }\n    if (targetClick.closest(\".menu__link\")){\n        catalogOpen();\n    }\n    if(targetClick.closest(\".header__link\")){\n        linkRemoveMenu();\n    }\n}\nfunction burgerToggle() {\n    if(!document.documentElement.classList.contains(\"catalog-open\")){\n        document.documentElement.classList.toggle(\"menu-open\");\n    }\n    if(document.documentElement.classList.contains(\"catalog-open\")){\n        document.documentElement.classList.remove(\"catalog-open\")   \n    }\n}\nfunction catalogOpen() {\n    document.documentElement.classList.add(\"catalog-open\");\n}\nfunction linkRemoveMenu(params) {\n    document.documentElement.classList.remove(\"catalog-open\");\n    document.documentElement.classList.remove(\"menu-open\");     \n}\nfunction atributeChanger() {\n    let currentContentWidth = contentBlock.clientWidth;\n    if (currentContentWidth < contentWidth) {\n        let change = (currentContentWidth - contentWidth)/2;\n        let cordinatesFirst = -8 - change;\n        let cordinatesSecond = 250 + change;\n        let cordinatesThird = -4 - change;\n        let cordinatesFourth = 117 + change;\n\n        if (cordinatesFirst < 95) {\n            connectionFirst.setAttribute(\"d\", `M 220.901 107 L 94.8895 1 H ${cordinatesFirst}`);\n        }\n        else{\n            connectionFirst.setAttribute(\"d\", `M 220.901 107 L 94.8895 1 H 95`);\n        }\n\n        if (cordinatesSecond > 125) {\n            connectionSecond.setAttribute(\"d\", `M ${cordinatesSecond} 1H124.686L0.448619 96.9641`)\n        }\n        else{\n            connectionSecond.setAttribute(\"d\", `M125 1H124.686L0.448619 96.9641`); \n        }\n        \n        if (cordinatesThird < 94) {\n            connectionThird.setAttribute(\"d\", `M339.232 0.418814L94.6573 74.9739H ${cordinatesThird}`);\n        }\n        else{\n            connectionThird.setAttribute(\"d\", `M339.232 0.418814L94.6573 74.9739H 94`);\n        }\n\n        if (cordinatesFourth > 92) {\n            connectionFourth.setAttribute(\"d\", `M1 1L92.5 83H${cordinatesFourth}`); \n        }\n        else{\n            connectionFourth.setAttribute(\"d\", `M1 1L92.5 83H92`); \n        }\n    }\n    else{\n        connectionFirst.setAttribute(\"d\", `M 220.901 107 L 94.8895 1 H -8`); \n        connectionSecond.setAttribute(\"d\", `M250 1H124.686L0.448619 96.9641`); \n        connectionThird.setAttribute(\"d\", `M339.232 0.418814L94.6573 74.9739H-3.74317e-05`); \n        connectionFourth.setAttribute(\"d\", `M1 1L92.5 83H116.5`); \n    }\n}\nfunction mediaJS() {\n    let mediaCondition = window.matchMedia(\"(max-width: 1200.98px)\").matches;\n    if(mediaCondition && !placeSlider.classList.contains(\"swiper\")){\n        placeSlider.classList.add(\"swiper\");\n        placeSlider.classList.add(\"items-slider\");\n        placeWrapper.classList.add(\"swiper-wrapper\");\n        for (let index = 0; index < slides.length; index++) {\n            slides[index].classList.add(\"swiper-slide\");\n        }\n        (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__.initOptionalSlider)();   \n    }\n    else if(!mediaCondition && placeSlider.classList.contains(\"swiper\")){\n            placeSlider.classList.remove(\"swiper\", \"items-slider\", \"swiper-initialized\", \"swiper-horizontal\", \"swiper-android\", \"swiper-backface-hidden\");\n            placeSlider.removeAttribute(\"style\");\n            placeWrapper.classList.remove(\"swiper-wrapper\");\n            placeWrapper.removeAttribute(\"style\");\n            for (let index = 0; index < slides.length; index++) {\n                slides[index].classList.remove(\"swiper-slide\", \"swiper-slide-active\", \"swiper-slide-next\", \"swiper-slide-prev\");\n                slides[index].removeAttribute(\"style\");\n            }\n    }\n    atributeChanger();\n}\n\n(0,_libs_functions_js__WEBPACK_IMPORTED_MODULE_2__.spollers)();\n\nsetInterval(mediaJS, 10);\n\n\n\n\n\n//# sourceURL=webpack://rock/./src/js/app.js?");
